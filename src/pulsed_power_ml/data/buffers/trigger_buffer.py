...
from src.pulsed_power_ml.models.disaggregation_model import DisaggregationModel
...
class TriggerBuffer:
    def __init__(self, update_rate, data_points_to_show):
        ...
        self.model = DisaggregationModel()
    ...
    def update_data(self, new_data):
        ...
        self.buffer.extend(self.model.predict(new_data))
        ...
        self.data = pd.DataFrame(self.buffer, columns=['S', 'sEst', 'sLED', 'sHalo', 'sFluo'], index=self.index)
