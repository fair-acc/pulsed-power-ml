...
//  2022-03-22: Inputs: Fix mouse position issues when dragging outside of
//  boundaries. SDL_CaptureMouse() erroneously still gives out LEAVE events when
//  hovering OS decorations. 2022-03-22: Inputs: Added support for extra mouse
//  buttons (SDL_BUTTON_X1/SDL_BUTTON_X2). 2022-02-04: Added SDL_Renderer*
//  parameter to ImGui_ImplSDL2_InitForSDLRenderer(), so we can use
