#ifndef GR_THREEPHASEFLOWGRAPHS_HPP
#define GR_THREEPHASEFLOWGRAPHS_HPP
...
public:
    ...
    ~GRThreePhaseFlowGraph() { top->stop(); }
...
public:
    PulsedPowerThreePhaseFlowgraph(int noutput_items, bool use_picoscope = false)
        ...
        auto pulsed_power_power_calc_ff_1_0           = gr::pulsed_power::power_calc_ff::make(0.001);
        auto pulsed_power_power_calc_ff_2_0           = gr::pulsed_power::power_calc_ff::make(0.001);
        ...
        top->hier_block2::connect(band_pass_filter_voltage1, 0, pulsed_power_power_calc_ff_1_0, 0);
        top->hier_block2::connect(band_pass_filter_current1, 0, pulsed_power_power_calc_ff_1_0, 1);
        ...
        top->hier_block2::connect(blocks_sub_phase1, 0, pulsed_power_power_calc_ff_1_0, 2);
        // phase 2
        ...
        top->hier_block2::connect(band_pass_filter_voltage2, 0, pulsed_power_power_calc_ff_2_0, 0);
        top->hier_block2::connect(band_pass_filter_current2, 0, pulsed_power_power_calc_ff_2_0, 1);
        ...
        top->hier_block2::connect(blocks_sub_phase2, 0, pulsed_power_power_calc_ff_2_0, 2);
        ///Calculate P, Q, S, phi
        // phase 0
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 0, out_decimation_p_0_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 1, out_decimation_q_0_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 2, out_decimation_s_0_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 3, out_decimation_phi_0_shortterm, 0);
        ...
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 0, out_decimation_p_0_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 1, out_decimation_q_0_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 2, out_decimation_s_0_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 3, out_decimation_phi_0_midterm, 0);
        ...
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 0, out_decimation_p_0_longterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 1, out_decimation_q_0_longterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 2, out_decimation_s_0_longterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 3, out_decimation_phi_0_longterm, 0);
        ...
        // phase 1
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 0, out_decimation_p_1_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 1, out_decimation_q_1_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 2, out_decimation_s_1_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 3, out_decimation_phi_1_shortterm, 0);
        ...
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 0, out_decimation_p_1_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 1, out_decimation_q_1_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 2, out_decimation_s_1_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_1_0, 3, out_decimation_phi_1_midterm, 0);
        ...
        // phase 2
        top->hier_block2::connect(pulsed_power_power_calc_ff_2_0, 0, out_decimation_p_2_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_2_0, 1, out_decimation_q_2_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_2_0, 2, out_decimation_s_2_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_2_0, 3, out_decimation_phi_2_shortterm, 0);
        ...
        ///Statistics
        // phase 0
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 0, statistics_p_0_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 1, statistics_q_0_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 2, statistics_s_0_shortterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 3, statistics_phi_0_shortterm, 0);
        ...
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 0, statistics_p_0_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 1, statistics_q_0_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 2, statistics_s_0_midterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 3, statistics_phi_0_midterm, 0);
        ...
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 0, statistics_p_0_longterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 1, statistics_q_0_longterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 2, statistics_s_0_longterm, 0);
        top->hier_block2::connect(pulsed_power_power_calc_ff_0_0, 3, statistics_phi_0_longterm, 0);
