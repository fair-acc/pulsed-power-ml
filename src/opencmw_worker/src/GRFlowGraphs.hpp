...
public:
    PulsedPowerFlowgraph(int noutput_items, bool use_picoscope = false)
        ...
        auto integrate_s                   = gr::pulsed_power::integration::make(10, 1000, gr::pulsed_power::INTEGRATION_DURATION::DAY);
        auto integrate_P                   = gr::pulsed_power::integration::make(10, 1000, gr::pulsed_power::INTEGRATION_DURATION::DAY);
