    ...
    FlowgraphSimulated(int noutput_items)
        ...
        auto out_decimation_phi_shortterm = gr::filter::fft_filter_fff::make(
                ...
                gr::filter::firdes::low_pass(
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_p_midterm = gr::filter::fft_filter_fff::make(
                decimation_out_mid_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        400,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_q_midterm = gr::filter::fft_filter_fff::make(
                decimation_out_mid_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_s_midterm = gr::filter::fft_filter_fff::make(
                decimation_out_mid_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_phi_midterm = gr::filter::fft_filter_fff::make(
                decimation_out_mid_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_p_longterm = gr::filter::fft_filter_fff::make(
                decimation_out_long_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        400,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_q_longterm = gr::filter::fft_filter_fff::make(
                decimation_out_long_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_s_longterm = gr::filter::fft_filter_fff::make(
                decimation_out_long_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
                        ...
                        gr::fft::window::win_type::WIN_HAMMING,
                        6.76));
        auto out_decimation_phi_longterm = gr::filter::fft_filter_fff::make(
                decimation_out_long_term,
                gr::filter::firdes::low_pass(
                        1,
                        samp_rate_delta_phi_calc,
